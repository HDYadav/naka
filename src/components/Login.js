        ...
        <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
          ...
          <div className="md:w-1/2 px-8 md:px-16">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="flex flex-col gap-4">
              ...
              <button className="bg-[#002D74] rounded-xl text-white py-2 hover:scale-105 duration-300" onClick={handleButtomClick}>
                Login
              </button>
            </form>
          ...
          <div className="md:block hidden w-1/2">
            <img
              ...
              src="https://plus.unsplash.com/premium_photo-1677093906033-dc2beb53ace3?q=80&w=1480&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            />
          </div>
        </div>
      </section>
